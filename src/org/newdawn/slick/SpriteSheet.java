...
public class SpriteSheet extends Image {
	 ...
	 * @throws SlickException Indicates a failure to load the image
	 */
	public SpriteSheet(String ref,int tw,int th, SlickColor col) throws SlickException {
	 ...
	 * @throws SlickException Indicates a failure to load the image
	 */
	public SpriteSheet(String ref,int tw,int th, SlickColor col, int spacing) throws SlickException {
