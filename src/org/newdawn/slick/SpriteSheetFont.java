...
public class SpriteSheetFont implements Font {
	...
	/**
	 * @see org.newdawn.slick.Font#drawString(float, float, java.lang.String, org.newdawn.slick.SlickColor)
	 */
	...
	/**
	 * @see Font#drawString(float, float, String, SlickColor, int, int)
	 */
	public void drawString(float x, float y, String text, SlickColor col, int startIndex, int endIndex) {
		try {
