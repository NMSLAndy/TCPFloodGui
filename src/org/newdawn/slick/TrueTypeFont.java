...
public class TrueTypeFont implements org.newdawn.slick.Font {
	...
	public void drawString(float x, float y, String whatchars,
			org.newdawn.slick.SlickColor color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, org.newdawn.slick.SlickColor, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
			org.newdawn.slick.SlickColor color, int startIndex, int endIndex) {
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, org.newdawn.slick.SlickColor.white);
	}
