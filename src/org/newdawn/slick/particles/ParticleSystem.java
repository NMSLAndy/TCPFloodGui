...
public class ParticleSystem {
	...
	public static int BLEND_ADDITIVE = 1;
	/** The blending mode for the normal style */
	public static int BLEND_COMBINE = 2;
	
	/** The default number of particles in the system */
	private static int DEFAULT_PARTICLES = 100;
	 ...
	 */
	public ParticleSystem(String defaultSpriteRef, int maxParticles, SlickColor mask) {
