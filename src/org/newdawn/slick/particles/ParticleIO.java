...
public class ParticleIO {
	 ...
	 */
	public static ParticleSystem loadConfiguredSystem(String ref, SlickColor mask)
			throws IOException {
	 ...
	 *             Indicates a failure to find, read or parse the XML file
	 */
	public static ParticleSystem loadConfiguredSystem(InputStream ref, SlickColor mask)
			throws IOException {
    ...
    */
   public static ParticleSystem loadConfiguredSystem(InputStream ref,
         ConfigurableEmitterFactory factory, ParticleSystem system, SlickColor mask) throws IOException {
		if (factory == null) {
	...
	private static void elementToEmitter(Element element,
		...
		for (int i = 0; i < steps.getLength(); i++) {
			...
			emitter.addColorPoint(offset, new SlickColor(r, g, b, 1));
		}
