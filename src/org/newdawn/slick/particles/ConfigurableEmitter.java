...
public class ConfigurableEmitter implements ParticleEmitter {
	...
	public ConfigurableEmitter(String name) {
		...
		colors.add(new ColorRecord(0, SlickColor.white));
		colors.add(new ColorRecord(1, SlickColor.red));
	...
	public void updateParticle(Particle particle, int delta) {
		...
		SlickColor startColor = null;
		SlickColor endColor = null;
	...
	public class ColorRecord {
		 ...
		 */
		public ColorRecord(float pos, SlickColor col) {
			this.pos = pos;
			this.col = col;
		}
	}
	 ...
	 *            The color applied at this position
	 */
	public void addColorPoint(float pos, SlickColor col) {
