...
public class Particle {
	...
	protected SlickColor color = SlickColor.white;
	...
	public void setColor(float r, float g, float b, float a) {
		if (color == SlickColor.white) {
			color = new SlickColor(r,g,b,a);
		} else {
			color.r = r;
			color.g = g;
			color.b = b;
