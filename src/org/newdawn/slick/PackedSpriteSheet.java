...
public class PackedSpriteSheet {
	 ...
	 * @throws SlickException Indicates a failure to read the definition file
	 */
	public PackedSpriteSheet(String def, SlickColor trans) throws SlickException {
		def = def.replace('\\', '/');
	 ...
	 * @throws SlickException Indicates a failure to read the definition file
	 */
	public PackedSpriteSheet(String def, int filter, SlickColor trans) throws SlickException {
		this.filter = filter;
	 ...
	 * or referenced image.
	 */
	private void loadDefinition(String def, SlickColor trans) throws SlickException {
