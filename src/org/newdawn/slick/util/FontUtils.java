...
public class FontUtils {
	...
	public static void drawLeft(Font font, String s, int x, int y) {
		drawString(font, s, Alignment.LEFT, x, y, 0, SlickColor.white);
	}
	...
	public static void drawCenter(Font font, String s, int x, int y, int width) {
		drawString(font, s, Alignment.CENTER, x, y, width, SlickColor.white);
	}
	...
	public static void drawRight(Font font, String s, int x, int y, int width) {
		drawString(font, s, Alignment.RIGHT, x, y, width, SlickColor.white);
	}
	 ...
	 */
	public static int drawString(Font font, String s,
			int alignment, int x, int y, int width,
			SlickColor color) {
	 ...
	 */
	private static int calculateWidthOfJustifiedSpaceInPixels(Font font,
			String s, int leftWidth) {
