...
public class Renderer {		
	...
	public final static int IMMEDIATE_RENDERER = 1;
	/** The indicator for vertex array based rendering */
	public final static int VERTEX_ARRAY_RENDERER = 2;
	
	/** The indicator for direct GL line renderer (the default) */
	public final static int DEFAULT_LINE_STRIP_RENDERER = 3;
	/** The indicator for consistant quad based lines */
	public final static int QUAD_BASED_LINE_STRIP_RENDERER = 4;
