...
public interface SGL {
	...
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_POINT_SMOOTH = GL11.GL_POINT_SMOOTH;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_POLYGON_SMOOTH = GL11.GL_POLYGON_SMOOTH;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_LINE_SMOOTH = GL11.GL_LINE_SMOOTH;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_SCISSOR_TEST = GL11.GL_SCISSOR_TEST;

	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_MODULATE = GL11.GL_MODULATE;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_TEXTURE_ENV = GL11.GL_TEXTURE_ENV;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_TEXTURE_ENV_MODE = GL11.GL_TEXTURE_ENV_MODE;

	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_QUADS = GL11.GL_QUADS;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_POINTS = GL11.GL_POINTS;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_LINES = GL11.GL_LINES;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_LINE_STRIP = GL11.GL_LINE_STRIP;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_TRIANGLES = GL11.GL_TRIANGLES;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_TRIANGLE_FAN = GL11.GL_TRIANGLE_FAN;

	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_SRC_ALPHA = GL11.GL_SRC_ALPHA;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_ONE = GL11.GL_ONE;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_ONE_MINUS_DST_ALPHA = GL11.GL_ONE_MINUS_DST_ALPHA;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_DST_ALPHA = GL11.GL_DST_ALPHA;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_ONE_MINUS_SRC_ALPHA = GL11.GL_ONE_MINUS_SRC_ALPHA;

	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_COMPILE = GL11.GL_COMPILE;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_MAX_TEXTURE_SIZE = GL11.GL_MAX_TEXTURE_SIZE;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	...
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_COLOR_CLEAR_VALUE = GL11.GL_COLOR_CLEAR_VALUE;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_LINE_WIDTH = GL11.GL_LINE_WIDTH;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_CLIP_PLANE0 = GL11.GL_CLIP_PLANE0;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_CLIP_PLANE1 = GL11.GL_CLIP_PLANE1;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_CLIP_PLANE2 = GL11.GL_CLIP_PLANE2;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_CLIP_PLANE3 = GL11.GL_CLIP_PLANE3;
	
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_COMPILE_AND_EXECUTE = GL11.GL_COMPILE_AND_EXECUTE;

	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_RGBA8 = GL11.GL_RGBA;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_RGBA16 = GL11.GL_RGBA16;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_BGRA = GL12.GL_BGRA;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_MIRROR_CLAMP_TO_EDGE_EXT = EXTTextureMirrorClamp.GL_MIRROR_CLAMP_TO_EDGE_EXT;
	...
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_COLOR_SUM_EXT = EXTSecondaryColor.GL_COLOR_SUM_EXT;

	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_ALWAYS = GL11.GL_ALWAYS;

	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_DEPTH_TEST = GL11.GL_DEPTH_TEST;

	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_NOTEQUAL = GL11.GL_NOTEQUAL;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_EQUAL = GL11.GL_EQUAL;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_SRC_COLOR = GL11.GL_SRC_COLOR;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_ONE_MINUS_SRC_COLOR = GL11.GL_ONE_MINUS_SRC_COLOR;
	/** OpenGL Enum - @url http://www.opengl.org/documentation */
	public static int GL_MODELVIEW_MATRIX = GL11.GL_MODELVIEW_MATRIX;
