...
public class FadeOutTransition implements Transition {
	 ...
	 */
	public FadeOutTransition(SlickColor color) {
		this(color, 500);
	}
	 ...
	 */
	public FadeOutTransition(SlickColor color, int fadeTime) {
		this.color = new SlickColor(color);
		this.color.a = 0;
