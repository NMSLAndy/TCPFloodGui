...
public class GradientFill implements ShapeFill {
	...
	private SlickColor startCol;
	/** The ending colour of the gradient */
	private SlickColor endCol;
	 ...
	 */
	public GradientFill(float sx, float sy, SlickColor startCol, float ex, float ey, SlickColor endCol) 
	{
	 ...
	 */
	public GradientFill(float sx, float sy, SlickColor startCol, float ex, float ey, SlickColor endCol, boolean local) 
	{
	 ...
	 * @param local True if the gradient is defined in local shape coordinates
	 */
	public GradientFill(Vector2f start, SlickColor startCol, Vector2f end, SlickColor endCol, boolean local) {
		this.start = new Vector2f(start);
		this.end = new Vector2f(end);
		this.startCol = new SlickColor(startCol);
		this.endCol = new SlickColor(endCol);
		this.local = local;
	}
	 ...
	 */
	public SlickColor getStartColor() {
		return startCol;
	}
	 ...
	 */
	public void setStartColor(SlickColor color) {
		this.startCol = new SlickColor(color);
	}
	 ...
	 */
	public void setEndColor(SlickColor color) {
		this.endCol = new SlickColor(color);
	}
	 ...
	 */
	public SlickColor colorAt(Shape shape, float x, float y) {
		if (local) {
	 ...
	 * @return The colour that should be applied based on the control points of this gradient
	 */
	public SlickColor colorAt(float x, float y) {
		...
		SlickColor col = new SlickColor(1,1,1,1);
