...
public class TextField extends AbstractComponent {
	...
	private static int INITIAL_KEY_REPEAT_INTERVAL = 400;
	/** The key repeat interval */
	private static int KEY_REPEAT_INTERVAL = 50;
	...
	private SlickColor border = SlickColor.white;

	/** The text color */
	private SlickColor text = SlickColor.white;

	/** The background color - null if no background */
	private SlickColor background = new SlickColor(0, 0, 0, 0.5f);
	 ...
	 */
	public void setBackgroundColor(SlickColor color) {
		background = color;
	}
	 ...
	 */
	public void setBorderColor(SlickColor color) {
		border = color;
	}
	 ...
	 */
	public void setTextColor(SlickColor color) {
		text = color;
	}
