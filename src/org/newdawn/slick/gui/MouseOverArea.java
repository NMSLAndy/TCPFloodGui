...
public class MouseOverArea extends AbstractComponent {
	...
	private static int MOUSE_DOWN = 2;

	/** The mouse over state */
	private static int MOUSE_OVER = 3;
	...
	private SlickColor normalColor = SlickColor.white;

	/** The colour used in mouseOver state */
	private SlickColor mouseOverColor = SlickColor.white;

	/** The colour used in mouseDown state */
	private SlickColor mouseDownColor = SlickColor.white;
	...
	private SlickColor currentColor;
	 ...
	 */
	public void setNormalColor(SlickColor color) {
		normalColor = color;
	}
	 ...
	 */
	public void setMouseOverColor(SlickColor color) {
	 ...
	 */
	public void setMouseDownColor(SlickColor color) {
