...
public interface Font {
	 ...
	 */
	public abstract void drawString(float x, float y, String text, SlickColor col);
	 ...
	 */
	public abstract void drawString(float x, float y, String text, SlickColor col, int startIndex, int endIndex);
}