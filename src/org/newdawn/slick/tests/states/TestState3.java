...
public class TestState3 extends BasicGameState {
	...
	public void keyReleased(int key, char c) {
		...
		if (key == Input.KEY_1) {
			game.enterState(TestState1.ID, new FadeOutTransition(SlickColor.black), new FadeInTransition(SlickColor.black));
		}
		if (key == Input.KEY_2) {
			game.enterState(TestState2.ID, new FadeOutTransition(SlickColor.black), new FadeInTransition(SlickColor.black));
		}
	}
