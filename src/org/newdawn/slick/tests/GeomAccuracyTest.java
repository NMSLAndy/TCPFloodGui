...
public class GeomAccuracyTest extends BasicGame {
	/** The Geometry color */
	private SlickColor geomColor;
	
	/** The overlay color */
	private SlickColor overlayColor;
	...
	public void init(GameContainer container) throws SlickException {
		geomColor = SlickColor.magenta;
		overlayColor = SlickColor.white;
	...
	public void render(GameContainer container, Graphics g) {
		...
		g.setColor(SlickColor.darkGray);
	...
	private void setColors() {
		switch(colorIndex)
		{
			...
			case 1:
				overlayColor = SlickColor.magenta;
				geomColor = SlickColor.white;
				break;
	
			case 2:
				overlayColor = SlickColor.red;
				geomColor = SlickColor.green;
				break;
