...
public class ImageBufferEndianTest extends BasicGame {
   ...
   public void init(GameContainer container) throws SlickException {
      ...
      fillImageBufferWithColor(redImageBuffer, SlickColor.red, 100, 100);
      
      blueImageBuffer = new ImageBuffer(100,100);
      fillImageBufferWithColor(blueImageBuffer, SlickColor.blue, 100, 100);
    ...
    */
   private void fillImageBufferWithColor(ImageBuffer buffer, SlickColor c, int width, int height) {
