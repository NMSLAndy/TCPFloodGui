...
public class ImageGraphicsTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		offscreenPreload.setColor(SlickColor.blue.brighter());
		offscreenPreload.drawOval(200, 30, 50, 50);
		offscreenPreload.setColor(SlickColor.white);
	...
	public void render(GameContainer container, Graphics g) throws SlickException {
		...
		gTarget.setBackground(new SlickColor(0,0,0,0));
		gTarget.clear();
