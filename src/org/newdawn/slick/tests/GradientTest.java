...
public class GradientTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		gradient = new GradientFill(0,-75,SlickColor.red,0,75,SlickColor.yellow,true);
		gradient2 = new GradientFill(0,-75,SlickColor.blue,0,75,SlickColor.white,true);
		gradient4 = new GradientFill(-50,-40,SlickColor.green,50,40,SlickColor.cyan,true);
	}
