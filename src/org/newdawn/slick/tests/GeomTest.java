...
public class GeomTest extends BasicGame {
	...
	public void render(GameContainer container, Graphics g) {
        ...
        g.translate(-50,-50);
        g.scale(10, 10);
        g.setColor(SlickColor.red);
        g.fillRect(0,0,5,5);
        g.setColor(SlickColor.white);
        g.drawRect(0,0,5,5);
        g.popTransform();
        g.setColor(SlickColor.green);
		...
		g.setColor(rect1.intersects(rect) ? SlickColor.red : SlickColor.green);
		g.draw(rect1);
		g.setColor(rect2.intersects(rect) ? SlickColor.red : SlickColor.green);
		g.draw(rect2);
        g.setColor(roundRect.intersects(rect) ? SlickColor.red : SlickColor.green);
        g.draw(roundRect);
		g.setColor(circle1.intersects(rect) ? SlickColor.red : SlickColor.green);
		g.draw(circle1);
		g.setColor(circle2.intersects(rect) ? SlickColor.red : SlickColor.green);
		g.draw(circle2);
		g.setColor(circle3.intersects(circle) ? SlickColor.red : SlickColor.green);
		g.fill(circle3);
		g.setColor(circle4.intersects(circle) ? SlickColor.red : SlickColor.green);
		g.draw(circle4);

        g.fill(roundRect2);
		g.setColor(SlickColor.blue);
        g.draw(roundRect2);
		g.setColor(SlickColor.blue);
