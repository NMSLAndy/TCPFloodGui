...
public class BigImage extends Image {
	...
	private void build(LoadableImageData data, ByteBuffer imageBuffer, int filter, int tileSize) {
		int dataWidth = data.getTexWidth();
		int dataHeight = data.getTexHeight();
		...
		for (int x=0;x<xcount;x++) {
			for (int y=0;y<ycount;y++) {
				...
				int imageWidth = Math.min((realWidth - (x*tileSize)), tileSize); 
				int imageHeight = Math.min((realHeight - (y*tileSize)), tileSize);
				
				int xSize = tileSize;
				int ySize = tileSize;
				
				ByteBuffer subBuffer = BufferUtils.createByteBuffer(tileSize*tileSize*components);
	...
	/**
	 * @see org.newdawn.slick.Image#draw(float, float, org.newdawn.slick.SlickColor)
	 */
	...
	/**
	 * @see org.newdawn.slick.Image#draw(float, float, float, org.newdawn.slick.SlickColor)
	 */
	...
	/**
	 * @see org.newdawn.slick.Image#draw(float, float, float, float, org.newdawn.slick.SlickColor)
	 */
	...
	public void draw(float x, float y, float scale) {
		draw(x,y,scale,SlickColor.white);
	}
	...
	/**
	 * @see org.newdawn.slick.Image#draw(float, float, float, float, float, float, float, float, org.newdawn.slick.SlickColor)
	 */
	public void draw(float x, float y, float x2, float y2, float srcx,
			float srcy, float srcx2, float srcy2, SlickColor filter) {	
		int srcwidth = (int) (srcx2 - srcx);
		int srcheight = (int) (srcy2 - srcy);
	...
	/**
	 * @see org.newdawn.slick.Image#drawEmbedded(float, float, float, float, float, float, float, float, org.newdawn.slick.SlickColor)
	 */
	...
	/**
	 * @see org.newdawn.slick.Image#drawFlash(float, float, float, float, org.newdawn.slick.SlickColor)
	 */
